...
setup(name='examples.conference',
      version=version,
      description="Dexterity content type example following http://developer.plone.org/reference_manuals/external/plone.app.dexterity/",
